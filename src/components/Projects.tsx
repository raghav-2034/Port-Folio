              ...
              <div className="group bg-black/30 border border-gray-800 rounded-lg overflow-hidden hover:border-gray-600 transition-all duration-300 hover:scale-[1.02] hover:bg-black/50">
                <div className="p-8">
                  <div className="flex flex-col lg:flex-row lg:items-start gap-8">
                    <div className="flex-1">
                      <div className="flex items-center gap-4 mb-4">
                        <div className={`w-3 h-3 rounded-full bg-gradient-to-r ${projects[1].color} group-hover:scale-125 transition-transform duration-300`}></div>
                        <span className="text-sm text-gray-400 flex items-center gap-2 group-hover:text-gray-300 transition-colors duration-300">
                          <Calendar size={16} className="group-hover:rotate-12 transition-transform duration-300" />
                          {projects[1].period}
                        </span>
                        <span className={`px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${projects[1].color} text-white group-hover:scale-105 transition-transform duration-300`}>
                          {projects[1].status}
                        </span>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-6">
                        {projects[1].technologies.map((tech, techIndex) => (
                          <span
                            key={techIndex}
                            className="px-3 py-1 bg-gray-800 text-gray-300 rounded-full text-sm border border-gray-700 hover:border-gray-600 transition-all duration-200 hover:scale-105"
                          >
                      ...
                      <div className="flex gap-4">
                        ...
                        <a
                          href="https://quakeiq.netlify.app/"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="group/btn flex items-center gap-2 px-4 py-2 border border-gray-600 text-gray-300 rounded-lg hover:border-white hover:text-white transition-all duration-200 hover:scale-105"
                        >
                          <ExternalLink size={16} className="group-hover/btn:rotate-12 transition-transform duration-300" />
                          <span>Live Demo</span>
                        </a>
                    ...
                    <div className="lg:w-80">
                      <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700 group-hover:border-gray-600 transition-all duration-300 hover:bg-gray-800/70">
                        <h4 className="text-lg font-semibold mb-4 flex items-center gap-2 group-hover:text-gray-200 transition-colors duration-300">
                          <Zap size={18} className={`text-transparent bg-gradient-to-r ${projects[1].color} bg-clip-text group-hover:rotate-12 transition-transform duration-300`} />
                          Key Features
                        </h4>
                        <ul className="space-y-2">
                          {projects[1].features.map((feature, featureIndex) => (
                            <li key={featureIndex} className="flex items-start gap-2 text-sm text-gray-300 group-hover:text-gray-200 group-hover:translate-x-2 transition-all duration-300">
                              <div className={`w-1.5 h-1.5 rounded-full bg-gradient-to-r ${projects[1].color} mt-2 flex-shrink-0 group-hover:scale-125 transition-transform duration-300`}></div>
                              <span>{feature}</span>
                            </li>
                          ))}
            ...
            <div className="group bg-black/30 border border-gray-800 rounded-lg overflow-hidden hover:border-gray-600 transition-all duration-300 hover:scale-[1.02] hover:bg-black/50">
              <div className="p-8">
                <div className="flex flex-col lg:flex-row lg:items-start gap-8">
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-4">
                      <div className={`w-3 h-3 rounded-full bg-gradient-to-r ${projects[0].color} group-hover:scale-125 transition-transform duration-300`}></div>
                      <span className="text-sm text-gray-400 flex items-center gap-2 group-hover:text-gray-300 transition-colors duration-300">
                        <Calendar size={16} className="group-hover:rotate-12 transition-transform duration-300" />
                        {projects[0].period}
                      </span>
                      <span className={`px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${projects[0].color} text-white group-hover:scale-105 transition-transform duration-300`}>
                        {projects[0].status}
                      </span>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <a
                        href="https://lovely-seahorse-1b63ce.netlify.app/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group/btn flex items-center gap-2 px-4 py-2 border border-gray-600 text-gray-300 rounded-lg hover:border-white hover:text-white transition-all duration-200 hover:scale-105"
                      >
